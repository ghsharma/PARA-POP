...
const Demo = () => {
  ...
  const handleCopy = (copyUrl) =>{
    ...
    setTimeout(() => detCopies (false) , 3000);
  }
      ...
      <div className='my-10 max-w-full flex justify-center items-center'>
        {isFetching ? (
          ...
          <p className='font-inter font-bold text-blacktext-center'>
            ...
            <br /><span className='font-santoshi font-normal text-gray-700'>
              {error?.data?.error}
            </span>
          </p>
        ) : (
...
<div className='relative flex justify-center items-center mb-2 gap-3'>
  created by <span className='font-satoshi text-blue-700'>GOVIND HARSH SHARMA.</span><br/>
